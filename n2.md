...
**{wave} continues to change in the same direction**

**are just getting {wave}er**

**{dots} is getting more and more/less and less {wave}**
...
{formal} **{wave} is in progress**

{formal} **{wave} is progressing**
...
{wave} is of higher significance, but {dots} is/are being included as well. 
...
{wave} and {dots} may include things of the same level of significance.
...
{wave} and the following things always have the same valuation.  They are either both good or both bad.
...
**It/he/she could be called {wave} but...**

**You could say that {wave} but...**
...
**When it comes to {wave}...**

**When thinking of {wave}, the first thing that comes to mind is...**
...
**Speaking of {wave}, surprisingly...**

**You wouldn't believe it, but {wave}...**
...
**Although {wave} is happening...**

**Although {wave} is the case...**
...
**Although it was said that {wave}...**

**{wave} is different from how it was probably imagined.**
...
**If a hypothetical "what if" situation like {wave} happened...**

〜とすると does not express the speaker's intention or attempt to persuade.

[[[
{noun}だ             | としたら
{verb}{plain-form}   | とすれば
{i-adj}{plain-form}  | とすると
{na-adj}{plain-form} |
]]]
...
**If a realistic situation that could actually affect the speaker like {wave} happened...**

〜となると does not express the speaker's intention or attempt to persuade.

[[[
{noun}（だ）          | となったら
{verb}{plain-form}   | となれば
{i-adj}{plain-form}  | となると
{na-adj}{plain-form} |
]]]
...
**If I could do {wave}, then I'd like to...**

{wave} is something that is probably impossible.

Can also be used to spur someone to action as in: "If it can be done, then do it!"
...
More literal: If {wave} were left out/omitted, then...

{wave} is something that the speaker considers to be of high value.
...
**Even if {wave} were (hypothetically) the case...**
...
> - {skm} N2-69
> - {djg} A-418（としても・にしろ・にせよ)

### 〜にしても・〜にしろ・〜にせよ

**Even if {wave} were (hypothetically or realistically) the case...**

[[[
{noun}
{noun}~~だ~~である    | にしても
{verb}{plain-form}   | にしろ
{i-adj}{plain-form}  | にせよ
{na-adj}~~だ~~である  |
]]]
...
> - {skm} N2-69
> - {djg}  A-435（にしても), A-418（としても・にしろ・にせよ)

# １６課　〜だから（{理由|り,ゆう}）‐１

## ①　〜によって・～により・～による

{formal} **Because of {wave}...**

{formal} **By means of {wave}...**
...
[[[
{noun}の |
{verb}{plain-form}   | おかげだ
{i-adj}{plain-form}  | せいだ
{na-adj}~~だ~~な     |
]]]
...
It can come at the end of a sentence, with the following sentence expressing the conclusion.
...
**As might be expected of {wave}...**

**Since {wave} is more extreme than usual...**
...
**I absolutely wanted to make {wave} a reality, so I did something unusual.**

Does not express the speaker's conclusion, hopes, intentions, or attempt to persuade.

The second meaning is often seen with the たい form.
...
**Even if I wanted to, I don't know how to do {wave}**

**It's impossible to {wave}**

More literally:  There is no method to {wave}

Emphasizes a nuance of impossibility.
...
{wave} is something that the subject would have liked to do.
...
It is possible: {得|う}る

It is not possible: {得|え}ない

Part of common phrase: あり{得|え}ない

Usually used to talk about general possibility, not a specific person's ability or what is allowed in a particular situation.

{得|う}る can also be read as {得|え}る, but {得|う}る is more common when used as an auxiliary verb.

{得|え}ない can**not** be read with an う.
...
Only used with the past tense.  That's why it starts with た, which is the end of the previous past-tense verb.
...
**Ever since doing {wave}...**

**Nothing has changed since {wave}**

The next part is never a prediction.  It is always about the current situation that has continued since the original action.
...
**It seemed like {wave} would happen, but in the end it did not**

**It ended without {wave} occurring.**
...
**{wave} is a small degree**

**at least {wave}**

More often ぐらい when used with nouns.

[[[
{verb}{plain-form}  | ぐらい
{i-adj}{plain-form} | くらい
{na-adj}~~だ~~な    |
{noun}              |
]]]
...
｛noun}（{particle}）までして and {verb}てまで express surprise or exasperation.
...
**In regards to {dots}, there is not a single {wave}**

{wave} is an extreme example in the form of {一|いち} + a counter.  

[[[
（何・だれ） | 一＋counter | として | （…） | ない
]]]
...
Expresses surprise, but not the speaker's intentions.  Does not attempt to persuade.
...
{wave} is something that the subject wouldn't normally (want to) do.
...
Mainly used when the speaker observes the state of another person and then offers a conjecture about that person based on what was seen.
...
[[[
{verb}{dict-form}/{nai-form} | {恐|おそ}れがある
{noun}の                     | {恐|おそ}れがあります
                             | {恐|おそ}れがない
                             | {恐|おそ}れがありません
]]]
...
Not usually used in the first person.

ではあるまいか is a round-about way for the writer to give his/her opinion.

[[[
{u-verb}{dict-form}　              | まい
{ru-verb}/{irreg-verb}~~ない~~     |
す~~る~~                           |
{i-adj}くある                      |
{na-adj}ではある                   |
]]]
...
[[[
{verb}{plain-form}   | （から） | に{違|ちが}いない
{i-adj}{plain-form}  |         | に{相違|そう,い}ない
{na-adj}~~だ~~である  |         |
{noun}~~だ~~である　  |         |
]]]
...
Simply means the speaker has a strong conviction.  Possibly also that he/she thinks any reasonable person should agree.

Doesn't necessarily mean that the speaker feels like there's room for guessing as in 〜に{違|ちが}いない.

[[[
{verb}{plain-form}   | にきまっている
{i-adj}{plain-form}  |
{na-adj}~~だ~~       |
{noun}~~だ~~　       |
]]]
...
{i-adj}{plain-form}  | にすぎません
{na-adj}~~だ~~である  | にすぎなかった
{noun}               | にすぎませんでした
{noun}~~だ~~である　  |
]]]
...
{formal} **It's {wave} and nothing more/no one else**

{formal} **It's nothing/no one but {wave}**
...
**There's nothing better than {wave}**
...
だ can be conjugated to the past tense to talk about a missed opportunity.
...
**It's important (not) to {wave}.**

[[[
{verb}{dict-form}/{nai-form} | ことだ
                             | ことです
]]]
...
Not used with past form, for denial, or doubt.
...
**I will probably not {wave}**

**I don't plan to {wave}**

[[[
{u-verb}{dict-form}                        | まい
{ru-verb}/{irreg-verb}{dict-form}/~~ない~~ |
す~~る~~                                   |
]]]
...
**whether or not I should {wave}**

{wave} is the same verb twice.

[[[
{verb}{volitional-form} | か | {u-verb}){dict-form}                       | まいか
                        |    | {ru-verb}/{irreg-verb}{dict-form}/~~ない~~ |
                        |    | す~~る~~                                   |
]]]
...
**I will absolutely not {wave}**

**Do you *seriously* think I would {wave}?**

A strong emotional rebuke.

もんか is an even more casual form.
...
When used to talk about someone else, words that indicate doubt like ようだ or らしい are added.
...
When used to talk about someone else, words that indicate doubt like そうだ, ようだ, or らしい are added.
...
**Because of (situation), {wave} must be done**

**There is no choice but to {wave}**

Usually used when talking about oneself.

Often implies that the conclusion is common knowledge that anyone would agree with.

[[[
{verb}{nai-form} | わけに（は）いかない
                 | わけに（は）いかなかった
]]]
...
**It may be difficult, but I would love to {wave}**

**I wonder if I can/should {wave}**

Used with potential verbs or verbs that do not communicate the speaker's intentions.

[[[
{verb}{nai-form} | もの（だろう）か
]]]
...
Can also be used with an adjective-like verb in the た form such as 困った.
...
{written} **What a(n) {wave}!**

Sentence-final exclamatory phrase.

Often used with words that indicate degree such as どんなに and {何回|なん,かい}, plus words that indicate surprise like なんと and いったい.

[[[
Question word | {verb}{plain-form}     | ことだろう
              | {i-adj}{plain-form}    | ことか
              | {na-adj}~~だ~~な/である |
              | {noun}~~だ~~である      |  
]]]
...
<!--
Kanzen Master Verb Types:
Ⅰ: Godan (う)
Ⅱ: Ichidan (いる・える)
Ⅲ: Irregular (する・{来|く}る)
-->
